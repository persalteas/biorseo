...
class RNA
{
  public:
    ...
    string get_name_();
    string get_seq_();
    // vector<vector<int>>    get_basepair_type_();
  ...
  private:
    ...
    // vector<vector<int>>    basepair_type_; /* vector of base pair types */
...
// inline vector<vector<int>>    RNA::get_basepair_type_() { return basepair_type_; }
// inline int                    RNA::get_type(int i, int j) { return basepair_type_[i][j]; }
// inline int                    RNA::get_type(int i) { return basepair_type_[get_coord(i).first][get_coord(i).second]; }
